				...
				<div class="col-sm-12">
					...
					<div class="panel panel-default">
						...
						<div class="panel-body">
							...
							<form role="form" class="form-horizontal"  name="addUserform" method="post" action="servlet/UserServlet">
								 <input name="operation" type="hidden" id="operation" value="add">
								<div class="form-group">
									<label class="col-sm-2 control-label" for="field-1">学工号</label>
									
									<div class="col-sm-10">
										<input type="text" name="usernum" class="form-control" id="field-1" placeholder="学工号">
									</div>
								</div>
								...
								<div class="form-group">
									...
									<div class="col-sm-10">
										<input type="text" name="username" class="form-control" id="field-2" placeholder="用户名">
									</div>
								</div>
								...
								<div class="form-group">
									...
									<div class="form-block">
											<label>
												<input type="radio" name="userType" class="cbr"  value="2" checked>
												管理员
											</label>
											<br>
											<label>
								...
								<div class="form-group">
									...
									<div class="col-sm-10">
										<input type="text" name="realname" class="form-control" id="field-2" placeholder="真实姓名">
									</div>
								</div>
								<div class="form-group-separator"></div>
								<div class="form-group">
									...
									<div class="col-sm-10">
										<div class="form-block">
											<label>
												<input type="radio" name="sex" class="cbr"  value="1" checked>
												男
											</label>
											<br>
											<label>
