	...
	<div class="page-container"><!-- add class "sidebar-collapsed" to close sidebar by default, "chat-visible" to make chat appear always -->
				...
				<div class="col-sm-12">
					...
					<div class="panel panel-default">
						...
						<div class="panel-body">
							...
							<form role="form" class="form-horizontal"  name="editTaskform" method="post" action="servlet/TaskServlet">
     ...
     <input name="tasknum"  type="hidden" id="tasknum" value="<%=tasknum %>">
								...
								<div class="form-group">
									...
									<div class="col-sm-10">
										<input type="text" name="taskname" class="form-control" id="field-2" value="<%=task.getTaskname()%>">
									</div>
								</div>
								...
								<div class="form-group">
									...
									<div class="col-sm-10">
									<textarea rows="10" cols="30" name="taskdes" class="form-control" id="field-2" id="taskdes" value="<%=task.getTaskdes()%>"><%=task.getTaskdes()%></textarea>
								...
								<div class="form-group">
									...
									<div class="col-sm-10">
										<input type="text" name="taskdeadline" class="form-control" id="field-2" value="<%=task.getTaskdeadline()%>">
									</div>
								</div>
								<div class="form-group-separator"></div>
								<div class="form-group">
