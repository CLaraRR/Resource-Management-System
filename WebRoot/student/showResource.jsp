	...
	<input type="button" align="right" value="添加资源" onClick="location.href='../student/addResource.jsp'">
								<table cellspacing="0" class="table table-small-font table-bordered table-striped">
									<thead>
										<tr>
											<th>资源名</th>
											<th data-priority="1">资源描述</th>
											<th data-priority="3">发布日期</th>
...
%>
									<tbody>
										<tr>
											<th> <span class="co-name"><%=resource.getResourcename()%></span></th>
											<td><%=resource.getResourcedes()%></td>
											<td> <%=resource.getResourcedate() %></td>
											<td> <%=author %></td>
											...
											<td><input type="button" align="right" value="编辑" onClick="location.href='../student/editResource.jsp?resourcenum=<%=resource.getResourcenum()%>'"></td>
											<td align="center"><a href="servlet/ResourceServlet?operation=del&resourcenum=<%=resource.getResourcenum()%>" onclick='return window.confirm("该资源将被删除，\n您确实要删除资源吗？")'>删除</a></td>
										</tr>	
										  <%
                                         	}
                                          %>	
