								...
								<table cellspacing="0" class="table table-small-font table-bordered table-striped">
									<thead>
										<tr>
											...
											<th data-priority="3">下载</th>
											<th data-priority="3">举报</th>
...
%>
									<tbody>
										<tr>
											...
											<td><input type="button" align="right" value="举报" onClick="location.href='../student/addReport.jsp?resourcenum=<%=resource.getResourcenum()%>'"></td>
