				...
				<div class="col-sm-12">
					...
					<div class="panel panel-default">
						...
						<div class="panel-body">
							...
							<form role="form" class="form-horizontal"  name="editResourceform" method="post" action="servlet/ResourceServlet">
     ...
     %>
      <input name="resourcenum"  type="hidden" id="resourcenum" value="<%=resourcenum %>">
								...
								<div class="form-group">
									...
									<div class="col-sm-10">
										<input type="text" name="resourcename" class="form-control" id="field-2" value="<%=resource.getResourcename()%>">
									</div>
								</div>
								...
								<div class="form-group">
									...
									<div class="col-sm-10">
									<textarea rows="10" cols="30" name="resourcedes" class="form-control" id="field-2" id="resourcedes"><%=resource.getResourcedes()%></textarea>
								...
								<div class="form-group">
									...
									<div class="col-sm-10">
										<input type="text" name="resourcedate" class="form-control" id="field-2" value="<%=resource.getResourcedate()%>">
									</div>
								</div>
								-->
								<div class="form-group-separator"></div>
