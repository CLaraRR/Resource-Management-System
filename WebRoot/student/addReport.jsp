				...
				<div class="col-sm-12">
					...
					<div class="panel panel-default">
						...
						<div class="panel-body">
							...
							<form role="form" class="form-horizontal"  name="addReportform" method="post" action="servlet/ReportServlet" >
     ...
     %>
      <input name="resourcenum"  type="hidden" id="resourcenum" value="<%=resourcenum %>">
								...
								<div class="form-group">
									...
									<div class="col-sm-10">
										<input type="text" name="resourcename" class="form-control" id="field-2" value="<%=resource.getResourcename()%>" readonly="true" >
									</div>
								</div>
								...
								<div class="form-group">
									<label class="col-sm-2 control-label" for="field-2">举报原因</label>
									
									<div class="col-sm-10">
									<textarea  rows="10" cols="30" name="reason" class="form-control" id="field-2" id="reason" placeholder="举报原因"></textarea>
								...
								<div class="form-group">
									<label class="col-sm-2 control-label" for="field-2">举报日期</label>
									
									<div class="col-sm-10">
										<input type="text" name="reportdate" class="form-control" id="field-2" placeholder="举报日期">
									</div>
								</div>
								-->
								<div class="form-group-separator"></div>
